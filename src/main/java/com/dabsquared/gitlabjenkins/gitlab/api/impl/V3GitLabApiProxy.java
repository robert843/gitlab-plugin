...
interface V3GitLabApiProxy extends GitLabApiProxy {
    ...
    @Override
    default void addRelease(@PathParam("projectId") Integer projectId, @FormParam("name") String name, @FormParam("tag_name") String tag_name, @FormParam("description") String description){
